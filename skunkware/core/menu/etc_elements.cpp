...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilledMultiColorRounded(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x - 115, 32), ImColor(24, 24, 26), ImColor(158, 0, 207, 50), ImColor(158, 0, 207, 0), ImColor(158, 0, 207, 0), ImColor(158, 0, 207, 50), 4.0f, ImDrawCornerFlags_TopLeft);
    parent_window->DrawList->AddText(bold, 15.0f, parent_window->DC.CursorPos + ImVec2(16, 9), ImColor(158, 0, 207), name);
