...
#include "../../dependencies/utilities/netvars/newnetvars.hpp"
...
public:
	...
	{
		const static auto m_CollisionGroup = *(uintptr_t*)(this + netvars::get_netvar_offset("DT_BaseEntity", "m_CollisionGroup", interfaces::i_client_class, "m_CollisionGroup", 0));
	...
	int flags(c_client_class* client_class)
	{
		return *(int*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_fFlags", client_class, "m_fFlags", 0));
	}

	int team(c_client_class* client_class = interfaces::i_client_class)
	{
		return *(int*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_iTeamNum", client_class, "m_iTeamNum", 0));
	}
	...
	vec3_t view_offset()
	{
		return *(vec3_t*)(this + netvars::get_netvar_offset("DT_BasePlayer", "m_vecViewOffset", interfaces::i_client_class, "m_vecViewOffset", 0));
	}

	vec3_t origin()
	{
		return *(vec3_t*)(this + netvars::get_netvar_offset("DT_BasePlayer", "m_vecOrigin", interfaces::i_client_class, "m_vecOrigin", 0));
	}

	vec3_t mins()
	{
		return *(vec3_t*)(this + netvars::get_netvar_offset("DT_BaseEntity", "m_vecMins", interfaces::i_client_class, "m_vecMins", 0));
	}

	vec3_t maxs()
	{
		return *(vec3_t*)(this + netvars::get_netvar_offset("DT_BaseEntity", "m_vecMaxs", interfaces::i_client_class, "m_vecMaxs", 0));
	}
};
...
public:
	...
	std::int32_t &model_index() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseViewModel", "m_nModelIndex", interfaces::i_client_class, "m_nModelIndex", 0));
	}
	std::int32_t &m_hweapon() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseViewModel", "m_hWeapon", interfaces::i_client_class, "m_hWeapon", 0));
	}
...
public:
	...
	std::int32_t& item_definition() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseAttributableItem", "m_iItemDefinitionIndex", interfaces::i_client_class, "m_iItemDefinitionIndex", 0));
	}
	std::int32_t& fallback_paint_kit() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseAttributableItem", "m_nFallbackPaintKit", interfaces::i_client_class, "m_nFallbackPaintKit", 0));
	}
	std::int32_t& fallback_wear() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseAttributableItem", "m_flFallbackWear", interfaces::i_client_class, "m_flFallbackWear", 0));
	}
	std::int32_t& entity_quality() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseAttributableItem", "m_iEntityQuality", interfaces::i_client_class, "m_iEntityQuality", 0));
	}
...
public:
	...
	std::int32_t& clip1_count() {
		return *(int*)(this + netvars::get_netvar_offset("DT_BaseCombatWeapon", "m_iClip1", interfaces::i_client_class, "m_iClip1", 0));
	}
...
public:
	...
	std::int32_t view_model() {
		return *(std::uint32_t*)(this + netvars::get_netvar_offset("DT_BasePlayer", "m_hViewModel[0]", interfaces::i_client_class, "m_hViewModel[0]", 0));
	}
	...
	bool is_scoped() {
		return *(bool*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_bIsScoped", interfaces::i_client_class, "m_bIsScoped", 0));
	}

	int health() {
		return *(int*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_iHealth", interfaces::i_client_class, "m_iHealth", 0));
	}

	int life_state(c_client_class* client_class) {
		return *(int*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_lifeState", client_class, "m_lifeState", 0));
	}
	...
	/*weapon_t* get_active_weapon() {
		return (weapon_t*)(this + netvars::get_netvar_offset("DT_BasePlayer", "m_aimPunchAngle", interfaces::i_client_class, "m_aimPunchAngle", 0));
	}*/

	vec3_t aim_punch_angle() {
		return *(vec3_t*)(this + netvars::get_netvar_offset("DT_BasePlayer", "m_aimPunchAngle", interfaces::i_client_class, "m_aimPunchAngle", 0));
	}

	std::uint32_t* get_weapons() {
		return (std::uint32_t*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_hMyWeapons", interfaces::i_client_class, "m_hMyWeapons", 0));
	}

	NETVAR("DT_DynamicProp", "m_bShouldGlow", should_glow, bool);

	std::uint32_t weapon_handle(c_client_class* client_class) {
		return *(int*)(this + netvars::get_netvar_offset("DT_CSPlayer", "m_hActiveWeapon", client_class, "m_hActiveWeapon", 0));
	}
	...
	{
		return reinterpret_cast<weapon_t*>(interfaces::entity_list->get_client_entity_handle(weapon_handle(interfaces::i_client_class)));
	}
	...
	bool is_alive(c_client_class* client_class)
	{
		return life_state(client_class) == 0;
	}
	...
	bool is_in_air(c_client_class* client_class)
	{
		if (this->flags(client_class) & fl_onground)
			return false;
...
public:
	...
	entity_t* get_base_entity()
	{
		return utilities::call_virtual< entity_t * (__thiscall*)(decltype(this)) >(this, 7)(this);
	}
};
...
{
public:
	i_client_unknown* get_client_unknown()
	{
		return utilities::call_virtual< i_client_unknown* (__thiscall*)(decltype(this)) >(this, 0)(this);
	}

	void draw_model(int flags, int instance)
	{
		return utilities::call_virtual< void (__thiscall*)(decltype(this), int, int) >(this, 10)(this, flags, instance);
