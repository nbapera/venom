...
public:
	...
	i_material* find_material(const char* material_name, const char* texture_group_name = nullptr, bool complain = true, const char* complain_prefix = nullptr) {
		using original_fn = i_material*(__thiscall*)(void*, const char*, const char*, bool, const char*);
		return (*(original_fn**)this)[84](this, material_name, nullptr, true, nullptr);
	}
